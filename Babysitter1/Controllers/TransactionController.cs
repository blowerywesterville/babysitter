...
namespace Babysitter1.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public TransactionController(BabysitterContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FamilyName,JobDate,TotalHours,EarlyHours,EveningHours,LateHours,Amount")] Transaction transaction)
        {
